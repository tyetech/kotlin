 ...
 */
fun case_9(value_1: _SealedClassEmpty?): String = <!NO_ELSE_IN_WHEN!>when<!> (value_1) {
    null -> ""
}
...
/*
 ...
 UNEXPECTED BEHAVIOUR
 */
fun case_11(value_1: _SealedClass?): String = <!NO_ELSE_IN_WHEN!>when<!> (value_1) {
...
/*
 ...
 UNEXPECTED BEHAVIOUR
 */
fun case_12(value_1: _SealedClass?): String = <!NO_ELSE_IN_WHEN!>when<!> (value_1) {
