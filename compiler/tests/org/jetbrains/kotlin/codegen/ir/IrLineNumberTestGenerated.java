...
public class IrLineNumberTestGenerated extends AbstractIrLineNumberTest {
    ...
    @RunWith(JUnit3RunnerWithInners.class)
    public static class LineNumber extends AbstractIrLineNumberTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTest, TargetBackend.JVM_IR, testDataFilePath);
        }

        public void testAllFilesPresentInLineNumber() throws Exception {
            KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/lineNumber"), Pattern.compile("^(.+)\\.kt$"), TargetBackend.JVM_IR, false);
        }
    ...
    public static class Custom extends AbstractIrLineNumberTest {
        private void runTest(String testDataFilePath) throws Exception {
            KotlinTestUtils.runTest(this::doTestCustom, TargetBackend.JVM_IR, testDataFilePath);
        }
